    ...
    <form>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                ...
                <select
                        id="priority"
                        class="form-control" v-model="selectpriroy">
                    <option v-for="pri in priroti" :key="pri">{{ pri }}</option>
                </select>
            </div>
        </div>
        <hr>
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <button
                        class="btn btn-primary" @click.prevent="sumited">Submit!
                </button>
            </div>
        </div>
    </form>
    <hr>
    <div class="row" v-if="isSumited">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <ul>
                        <li v-for="(sendemail,index) in SendMail" :key="index">
                            {{ sendemail }}
                        </li>
                    </ul>
                    <p>Gender: {{ gender }}</p>
                    <p>Priority: {{ selectpriroy }}</p>
                    <p>Switched:</p>
                </div>
            </div>
        </div>
